...
class ContextsPromptsDatasetGenerator:
    ...
    def create_prompts(self, labels_names):
        ...
        fromages = {
            "EMMENTAL": "Emmental, large wheel, noted for its smooth, hard, pale yellow rind and a pale yellow interior punctuated by large holes,",
            "FETA": "Feta, block or crumbled, creamy white interior, often without a rind,",
            "OSSAU- IRATY": "Ossau-Iraty, round or slightly oval, with a hard, dry, orange rind and a dense, creamy, ivory interior,",
            "MIMOLETTE": "Mimolette, spherical, distinguished by its bright orange, hard form with a dense, crumbly interior,",
            "MAROILLES": "Maroilles, square, with a moist, orange rind and a soft, sticky, deep yellow interior,",
            "GRUYÈRE": "Gruyère, large wheel, with a smooth, brown rind and a dense, pale yellow interior with small holes,",
            "MOTHAIS": "Mothais, round, wrapped cheese in chestnut leaves, with a thin rind and a creamy, soft, white interior,",
            ...
            "RACLETTE": "Raclette, large wheel cheese, semi-hard with a thin, smooth golden-brown rind and a pale yellow, elastic interior,",
            ...
            "SCAMORZA": "Scamorza, pear-shaped, sporting a smooth, thin rind with a dense, chewy, pale interior,",
